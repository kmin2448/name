...
const TIPS = [
  ...
  '왼쪽 위 "명패 제작기" 제목을 누르면 "이미지 변환" 페이지로 갈 수 있습니다. 로고·교표 같은 JPG·PNG를 확대해도 깨지지 않는 SVG로 바꿔 내려받는 기능으로, 변환은 브라우저 안에서만 이루어지고 파일이 서버로 올라가지 않습니다. (색이 잘게 나뉘는 일반 사진에는 맞지 않습니다)',
