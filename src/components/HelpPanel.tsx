...
const TIPS = [
  ...
  '캔버스 빈 곳에서 드래그하면 여러 항목을 한 번에 선택할 수 있습니다. 선택 후 정렬 버튼으로 줄을 맞추거나, 색상을 한 번에 바꾸거나, 방향키로 함께 이동시켜 보세요.',
